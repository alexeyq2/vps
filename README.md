...
### Правильный вариант небольшого VPN-узла
...
- URL с подпиской, в которой оба заграничных VPS - клиенты будут автопереключаться, если сервер не доступен и обновлять ключи.
