...
* Создать клиентов и указать им `flow: xtlx-rprx-vision`. Это и есть **VLESS-Reality**.
...
- автоматизировать получение/обновление сертификто-то еще было с Uатов для режима VLESS-Reality "сертификат берем у себя"
- обновлять geo-файлы, чтобы **трафик до России заворачивать назад через российский прокси, снижая шансы обнаружения VPN**.
- поднять ненапряжное файлохранилище, чтобы можно было дать прямую ссылку на файлы и скачать без регистрации. 10-20гигов особо никуда не загрузить, бесплатные облака начинают трещать.
