...
def main():
    ...
    parser.add_argument('--file', '-f', default='test_main.py', help='Test file to run (default: test_main.py)')
    ...
    pytest_args = ['test_main.py::TestUpdateGeo::test_update_geo_with_downloads']
    pytest_args += ['-s']
